...
const PoliceDiscord = () => {
  ...
  const [activeView, setActiveView] = useState("chat"); // "chat", "leftSidebar", "rightSidebar"
    ...
    <div className="discord-container">
      ...
      {isMobile() && (
        <div className="mobile-nav">
          <button onClick={() => setActiveView("leftSidebar")}>Communities</button>
          <button onClick={() => setActiveView("chat")}>Chat</button>
          <button onClick={() => setActiveView("rightSidebar")}>Officers</button>
        </div>
      )}

      {/* Left Sidebar */}
      <div className={`sidebar-left ${activeView === "leftSidebar" || !isMobile() ? "active" : ""}`}>
      ...
      {/* Chat Window */}
      <div className={`chat-window ${activeView === "chat" || !isMobile() ? "active" : ""}`}>
      ...
      <div className={`sidebar-right ${activeView === "rightSidebar" || !isMobile() ? "active" : ""}`}>
